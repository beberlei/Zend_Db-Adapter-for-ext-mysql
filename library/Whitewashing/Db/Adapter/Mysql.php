 ...
 */
require_once "Whitewashing/Db/Statement/Mysql.php";

class Whitewashing_Db_Adapter_Mysql extends Zend_Db_Adapter_Abstract
{
    /**
    ...
    {
        require_once "Whitewashing/Db/Adapter/Mysql/Exception.php";
        if($message === null) {
            $message = mysql_error($this->_connection)." (".mysql_errno($this->_connection).")";
        }
        throw new Whitewashing_Db_Adapter_Mysql_Exception($message);
    }
    ...
    {
        return new Whitewashing_Db_Statement_Mysql($this, $sql);
    }
